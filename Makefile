...
objdir    := objs
stdcpp    := c++11
cuda_home := anaconda3/lib/python3.8/site-packages/trtpy/trt8cuda115cudnn8
syslib    := anaconda3/lib/python3.8/site-packages/trtpy/lib
cpp_pkg   := anaconda3/lib/python3.8/site-packages/trtpy/cpp-packages
cuda_arch := 
